...
C {devices/isource.sym} 210 140 0 0 {name=I0 value=20u}
...
C {devices/code_shown.sym} 940 160 0 0 {name=MODELS only_toplevel=true
...
C {Analog/schematics/abraar_readout/ota5t_en.sym} 450 130 0 0 {name=x2}
